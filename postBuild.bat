...
copy ..\build-GalacticCalculator-Desktop_Qt_5_8_0_MinGW_32bit-Release\release\GalacticCalculator.exe "..\GalacticCalculator-ReleaseUpdate\GalacticCalculator.exe"
